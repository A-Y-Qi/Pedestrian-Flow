...
int main()
{
    ...
    outpos1 = fopen("Subway.xyz", "w");
    outpos2 = fopen("Subway.dat", "w");
    ...
    // change the disired direction to prevent trapping
    ...
    for (t = 0; t < 400; t += dt)
    {
        ...
        for (i = 0; i < pedestrian; i++)
        {
            ...
            Fsum_wall_x[i] = F_wall1_x[i] + F_wall2_x[i] + F_wall3_x[i] + F_wall4_x[i] + F_wall5_x[i] + F_wall6_x[i] + F_wall7_x[i];
            Fsum_wall_y[i] = F_wall1_y[i] + F_wall2_y[i] + F_wall3_y[i] + F_wall4_y[i] + F_wall5_y[i] + F_wall6_y[i] + F_wall7_y[i];
